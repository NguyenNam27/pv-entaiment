...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Chỉnh sửa thông tin sản phẩm <a href="{{route('admin.product.index')}}" class="btn bg-purple "><i
                        class="fa fa-plus"></i> Danh sách bài viết</a>

            </h1>
            <ol class="breadcrumb">
                <li><a href="{{route('admin.product.index')}}"><i class="fa fa-dashboard"></i> danh sách</a></li>
                <li><a href="{{route('admin.product.index')}}">thông tin sản phẩm</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" action="{{route('admin.product.update',['id'=>$edit->id])}}" method="post"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name = "subcategories_id">
                                            ...
                                            @foreach($sub as $sub)
                                                <option value="{{$sub->id}}" {{($edit->subcategories_id == $sub->id) ? 'selected' : '' }}>{{$sub->name}}</option>
                                            @endforeach
                                        </select>
                                        @if($errors->has('slug'))
                                            <label class="Text-red"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{$edit->price}}" type="text" class="form-control" name="price" id="price"
                                               placeholder="nhập ">
                                        @if($errors->has('price'))
                                            <label class="Text-red"
                                                   style="font-size:15px;font-weight:600;margin-top:5px;color:red">
