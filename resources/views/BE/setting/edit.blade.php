...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Chỉnh sửa Profile <a href="{{route('admin.setting.index')}}" class="btn bg-purple "><i class="fa fa-plus"></i> Danh sách profile</a>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <form action="{{route('admin.setting.update',['edit'=>$edit->id])}}" method ="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="box-body">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{$edit->company_name}}" type="text" class="form-control" name="company_name" placeholder="Enter company_name">
                                        @if($errors->has('company_name'))
                                            <label class="Text-red  " style="font-size:15px;font-weight:600;margin-top:5px;color:red" >
                                                <i class="fa fa-info"></i>{{$errors->first('company_name')}}
                                            </label>
                                        @endif
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{$edit->hotline}}" type="text" class="form-control" name ="hotline" id="hotline" placeholder="Enter address">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{$edit->address}}" type="text" class="form-control" name ="address" id="address" placeholder="Enter address">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" name="introduce" id="introduce"> {{$edit->introduce}}</textarea>
