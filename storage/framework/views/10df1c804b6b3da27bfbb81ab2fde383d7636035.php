<?php $__env->startSection('content'); ?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Sửa thông tin bài viết <a href="<?php echo e(route('admin.post.index')); ?>" class="btn bg-purple "><i
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" action="<?php echo e(route('admin.post.update',['edit'=>$edit->id])); ?>" method="post"
                            ...
                            <div class="box-body">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo e($edit->title); ?>" type="text" class="form-control" name="title" id="title"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo e($edit->key_word); ?>" type="text" class="form-control" name="key_word" id="key_word">
                                        <?php if($errors->has('key_word')): ?>
                                            <label class="Text-red"
                                                   style=" font-size:15px;font-weight:600;margin-top:5px;color:red">
                                                <i class="fa fa-info"></i><?php echo e($errors->first('key_word')); ?>
