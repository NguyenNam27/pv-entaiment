<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        <h1>
            DANH SÁCH BANNER <a href="<?php echo e(route('admin.banner.create')); ?>" class="btn bg-purple btn-flat"><i class="fa fa-plus"></i> Thêm</a>

        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-user"></i> QUẢN LÝ BANNER </a></li>
        </ol>
    </section>
                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="item-<?php echo e($item->id); ?>">
                                    ...
                                    <td>
                                        ...
                                        <a  href="<?php echo e(route('admin.banner.edit',['id'=>$item->id])); ?>" class="btn btn-warning btn-edit"><i class="fa fa-pencil">Sửa</i></a>
