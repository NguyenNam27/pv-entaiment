<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Chỉnh sửa Profile <a href="<?php echo e(route('admin.setting.index')); ?>" class="btn bg-purple "><i class="fa fa-plus"></i> Danh sách profile</a>

            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#"> Chỉnh sửa Profile </a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Chỉnh sửa Profile</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->

                        <form action="<?php echo e(route('admin.setting.update',['edit'=>$edit->id])); ?>" method ="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="box-body">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Tên tổ chức mới</label>
                                        <input value="<?php echo e($edit->company_name); ?>" type="text" class="form-control" name="company_name" placeholder="Enter company_name">
                                        <?php if($errors->has('company_name')): ?>
                                            <label class="Text-red  " style="font-size:15px;font-weight:600;margin-top:5px;color:red" >
                                                <i class="fa fa-info"></i><?php echo e($errors->first('company_name')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo e($edit->hotline); ?>" type="text" class="form-control" name ="hotline" id="hotline" placeholder="Enter address">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo e($edit->email); ?>" type="email" class="form-control" name ="email" id="email" placeholder="Enter email">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo e($edit->address); ?>" type="text" class="form-control" name ="address" id="address" placeholder="Enter address">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" name="introduce" id="introduce"> <?php echo e($edit->introduce); ?></textarea>
