<?php $__env->startSection('content'); ?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Chỉnh sửa thông tin sản phẩm <a href="<?php echo e(route('admin.product.index')); ?>" class="btn bg-purple "><i
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" action="<?php echo e(route('admin.product.update',['id'=>$edit->id])); ?>" method="post"
                            ...
                            <div class="box-body">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Tên sản phẩm mới</label>
                                        <input value="<?php echo e($edit->name); ?>" type="text" class="form-control" name="name" id="name"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo e($edit->slug); ?>" type="text" class="form-control" name="slug" id="slug"
                                               placeholder="nhập ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name = "subcategories_id">
                                            ...
                                            <?php $__currentLoopData = $sub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($sub->id); ?>" <?php echo e(($edit->subcategories_id == $sub->id) ? 'selected' : ''); ?>><?php echo e($sub->name); ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo e($edit->price); ?>" type="text" class="form-control" name="price" id="price"
                                               placeholder="nhập ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" name="short_description" id="short_description"><?php echo e($edit->short_description); ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" name="content" id="content"><?php echo e($edit->content); ?></textarea>
